...
class FsnAnalysisReportXlsx(models.AbstractModel):
    _name = 'report.all_in_one_inventory_analysis.report_fsn_analysis_xlsx'
    ...
    def generate_xlsx_report(self, workbook, data, stock):
        ...
        for obj in stock:
            ...
            row +=1
            fsn = dict(self.env['inventory.fsn.analysis']._fields['fsn_classification'].selection).get(stock[0].fsn_classification)
